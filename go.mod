...
replace go.opentelemetry.io/otel => github.com/redsift/opentelemetry-go v0.13.2-beta

replace go.opentelemetry.io/otel/exporters/otlp => github.com/redsift/opentelemetry-go/exporters/otlp v0.13.0

replace go.opentelemetry.io/otel/sdk => github.com/redsift/opentelemetry-go/sdk v0.13.2-beta
